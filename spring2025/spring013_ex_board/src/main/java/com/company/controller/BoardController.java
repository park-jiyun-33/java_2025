...
public class BoardController {
	...
	// 글쓰기화면 : X     + view (write.board)
	@RequestMapping(value="/create", method=RequestMethod.GET) 
	public String create() {return "board/write";}
	
	// 글쓰기기능 : 글쓰기 기능 insert(BoardDto dto)   + board/list (새로갱신된 list)
	...
	// 글상세보기 : 조회수 (updateHit(int bno)) + view (board/detail) 
	...
	// 글 수정기능 : update(BoardDto dto) + 글 수정확인-상세보기 갱신된(board/detail)
