...
public class Test2_boardDao {
	...
	@Test public void test1() {
		System.out.println(service.detail(1));  // 있는번호
	}
	
	@Test public void test() throws UnknownHostException {
		//5. delete
		//BoardDto dto = new BoardDto(); 
		//dto.setBpass("111"); dto.setBno(1);
		...
		//2. insert
		 ...
		 //BoardDto dto = new BoardDto(); dto.setBname("first"); dto.setBtitle("title");
		 //dto.setBpass("111"); dto.setBcontent("content");
