...
<body>
	<div class ="container card my-5">
		...
		1. application(웹애플리케이션 실행되고 있는동안) > session(브라우저종료) > request(요청) > page (해당페이지)
		2. 객체.setAttribute("속성", "값") / 객체.getAttrubute("속성")
		</pre>
		<%
		...
		<p><a href="jsp018_scope_2.jsp?a=1" class="btn btn-danger">SCOPE2</a></p>
	</div>
</body>
</html>