...
public class Lambda002 {
	public static void main(String[] args) {
		...
		InterA2 a3 = () -> System.out.println("hi");   a2.hi1();
		
		
		System.out.println("[STEP2] 매개변수o, 리턴값 x");
		// 2-1 익명객체 hi sally!
		...
		// 2-2 람다식
		InterB2 b2 = (String name) ->{System.out.println("hi " + name + "!2");}; b2.hi2("sally");
		InterB2 b3 = (String name) -> System.out.println("hi " + name + "!3"); b3.hi2("sally");
		InterB2 b4 =         name  -> System.out.println("hi " + name + "!4"); b4.hi2("sally");
		// 한개라면 ()생략가능
		
		
		System.out.println("[STEP3] 매개변수x, 리턴값 o");
		// 3-1 익명객체 good day!
		...
		System.out.println("[STEP4] 매개변수o, 리턴값 o");
		// 4-1 익명객체  ★ 문자열추가
		// hi sally! ★ System.out.println(d1.hi4(1, "hi sally!"));
