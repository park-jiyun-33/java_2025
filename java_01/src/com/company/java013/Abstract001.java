...
class Dog extends Animal{
	...
	@Override void poo()   {System.out.println(super.name + "강아지 시원!");} // 필요없어도 작성
}
public class Abstract001 {
	public static void main(String[] args) {
		// 1. abstract class : 일반클래스 + 설계
		// Animal ani = new Animal();  X  new 메모리 빌리고, 객체생성 / Animal()초기화 /  {}구 현부없음
		Animal ani = null;
		ani = new Cat();  // 부모 = 자식 / 업캐스팅 / 타입캐스팅 불필요
