...
public class Score2Process {
	...
	public void process_avg(Score2[] std) { // 주소따라가서 데이터 수정하겠습니다.
		...
		//ver1. std[0].avg = (std[0].kor + std[0].eng + std[0].math)/3.0   private - getters/setters
		//ver2. std[0].setAvg((std[0].getKor + std[0].getEng + std[0].getMath)/3.0);
