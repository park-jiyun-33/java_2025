...
public class Class002_Animal {
	public static void main(String[] args) {
		...
		// 1. new(공간, 객체 생성) 2. Animal002() 초기화  3. a1 주소 = 1번지
		Animal002 a2 = new Animal002(); a2.name="alpha"; a2.show();
		// 1. new(공간, 객체 생성) 2. Animal002() 초기화  3. a2 주소 = 2번지
	}
...
------------------------------------
[heap:동적]      |[stack:잠깐빌리기]
15번째줄: 2번지{name=null, age=0} ← a2 : 2번지  this
13번쨰줄: 1번지{name=null, age=0} ← a1 : 1번지  this
                   | main
------------------------------------
*/