...
// 멤버함수  - 클래스함수/인스턴스함수 
   ...
   //public static void showPay() {   System.out.println(this.pay);} // X :  this, 인스턴스 사용불가 
	 ...
	 public static  void  showAll002() {   // 클래스함수 - method - new X - 공유
	   //showAll001();    // X : 인스턴스 사용불가 - heap - new O - this, 생성자
	   //System.out.println(this.pay); // X
	 } 
}

public class MemverEx001 {
