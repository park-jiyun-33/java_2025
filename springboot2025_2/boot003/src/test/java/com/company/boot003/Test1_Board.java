...
public class Test1_Board {
	...
	public void insertMember() {
		...
		member.setName("second"); member.setAge(22);
	...
	public void insertboard() {
		Member member = new Member(); member.setId(2L); // 있는 유저번호 : 1L, 2L (없는 번호 : 3L)
		Board board = new Board();
		board.setBtitle("title2"); board.setBcontent("content2");
		board.setBpass("2222"); board.setBfile("2.jpg");
		try {
