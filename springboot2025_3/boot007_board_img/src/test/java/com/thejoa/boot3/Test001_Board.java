 ...
 * +-------------+--------------+------+-----+---------+----------------+ | id |
 * bigint | NO | PRI | NULL | auto_increment | | btitle | varchar(200) | YES | |
 * NULL | | | bcontent | text | YES | | NULL | | | bpass | varchar(255) | YES |
 * | NULL | | | bfile | varchar(255) | YES | | NULL | | | bhit | bigint | YES |
 * | NULL | | | bip | varchar(255) | YES | | NULL | | | create_date |
 * datetime(6) | YES | | NULL | | | member_id | bigint | YES | | NULL | |
 * +-------------+--------------+------+-----+---------+----------------+ 9 rows
 * in set (0.00 sec)
 */
